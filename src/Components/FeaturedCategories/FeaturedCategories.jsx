      ...
      <section id="feature-categories" className="scroll-smooth">
            ...
            <div className=" grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-9 gap-6">
                <div id="card"
                    ...
                    <img className="w-8/12 hover:scale-110 transition" src="../../public/assets/icons/cat-12.png" alt=""/>
                ...
                <div id="card"
                    ...
                    <img className="w-8/12 hover:scale-110 transition" src="../../public/assets/icons/cat-11.png" alt=""/>
                ...
                <div id="card"
                    ...
                    <img className="w-8/12 hover:scale-110 transition" src="../../public/assets/icons/cat-9.png" alt=""/>
                ...
                <div id="card"
                    className="hover:-translate-x-2 hover:-translate-y-1 hover:shadow-xl hover:border transition-all text-black  bg-orange-100 p-4 rounded-lg flex justify-center items-center flex-col">
                    <img className="w-8/12 hover:scale-110 transition" src="../../public/assets/icons/cat-3.png" alt=""/>
                ...
                <div id="card"
                    ...
                    <img className="w-8/12 hover:scale-110 transition" src="../../public/assets/icons/cat-1.png" alt=""/>
                ...
                <div id="card"
                    ...
                    <img className="w-8/12 hover:scale-110 transition" src="../../public/assets/icons/cat-2.png" alt=""/>
                ...
                <div id="card"
                    ...
                    <img className="w-8/12 hover:scale-110 transition" src="../../public/assets/icons/cat-4.png" alt=""/>
                ...
                <div id="card"
                    className="hover:-translate-x-2 hover:-translate-y-1 hover:shadow-xl hover:border transition-all text-black  bg-orange-100 p-4 rounded-lg flex justify-center items-center flex-col">
                    <img className="w-8/12 hover:scale-110 transition" src="../../public/assets/icons/cat-15.png" alt=""/>
