      ...
      <footer className="mt-10 ">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-4  ">
          ...
          <div className="grid gap-4 text-sm">
            <img src="../../../public/assets/svgs/logo.svg" alt="" />
            ...
            <div className="grid lg:gap-2 gap-3">
              <div
                ...
                <img className="" src="../../../public/assets/svgs/icon-location.svg" alt="" />
              ...
              <div className="flex items-center lg:flex-row flex-col lg:gap-2">
                <img src="../../../public/assets/svgs/icon-contact.svg" alt="" />
              ...
              <div className="flex items-center lg:flex-row flex-col lg:gap-2 flex-wrap">
                <img src="../../../public/assets/svgs/icon-email-2.svg" alt="" />
                <p className="font-semibold">Email:</p><span>nestsujoy@gmail.com</span>
              </div>
              <div className="flex items-center  lg:flex-row flex-col lg:gap-2">
                <img src="../../../public/assets/svgs/icon-clock.svg" alt="" />
                ...
                <div className="flex gap-2 lg:flex-row flex-col">
                  <a href="#ios-store">
                    <img className="w-3/4 lg:w-full hover:shadow-md hover:-translate-y-1 transition"
                      src="../../../public/assets/others/app-store.jpg" alt="" />
                  </a>
                  <a href="#play-store">
                    <img className="w-3/4 lg:w-full hover:shadow-md hover:-translate-y-1 transition"
                      src="../../../public/assets/others/google-play.jpg" alt="" />
                  </a>
                </div>
              </div>
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-2">
                  <img className="w-full hover:shadow-md hover:-translate-y-1 transition"
                    src="../../../public/assets/others/payment-method.png" alt="" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="" id="contact-us">
          <div
            ...
            <div className="flex lg:flex-row flex-col gap-4">
              <div className="flex gap-2 ">
                <img className="w-8 " src="../../../public/assets/svgs/phone-call.svg" alt="" />
              ...
              <div className="flex gap-2">
                ...
                <div className="flex gap-1">
                  <a href="https://web.facebook.com/sujoydas36"><img
                    ...
                    src="../../../public/assets/svgs/icon-facebook-white.svg" alt="" /></a>
                  <a href="https://github.com/devsujoy36"><img
                    className="bg-emerald-500 rounded-full p-1 w-6 hover:-translate-y-1 transition"
                    src="../../../public/assets/svgs/icon-twitter-white.svg" alt="" /></a>
                  <a href="https://github.com/devsujoy36"><img
                    className="bg-emerald-500 rounded-full p-1 w-6 hover:-translate-y-1 transition"
                    src="../../../public/assets/svgs/github.png" alt="" /></a>
