    ...
    <div className="max-w-screen-2xl lg:mx-auto mx-10">
      <div id="services" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div
                ...
                <img className="hover:-translate-y-2 transition w-12" src="../../../public/assets/svgs/icon-1.svg" alt=""/>
                <div>
            ...
            <div
                className="hover:shadow-md flex gap-2 justify-center items-center border p-5 rounded-lg hover:-translate-x-2 hover:-translate-y-2 transition-all">
                <img className="hover:-translate-y-2 transition w-12" src="../../../public/assets/svgs/icon-2.svg" alt=""/>
                <div>
            ...
            <div
                ...
                <img className="hover:-translate-y-2 transition w-12" src="../../../public/assets/svgs/icon-3.svg" alt=""/>
                <div>
            ...
            <div
                className="hover:shadow-md flex gap-2 justify-center items-center border p-5 rounded-lg hover:-translate-x-2 hover:-translate-y-2 transition-all">
                <img className="hover:-translate-y-2 transition w-12" src="../../../public/assets/svgs/icon-4.svg" alt=""/>
                <div>
            ...
            <div
                ...
                <img className="hover:-translate-y-2 transition w-12" src="../../../public/assets/svgs/icon-5.svg" alt=""/>
                <div>
            ...
            <div id="footer"
                ...
                <img className="hover:-translate-y-2 transition w-12" src="../../../public/assets/svgs/icon-6.svg" alt=""/>
                <div>
