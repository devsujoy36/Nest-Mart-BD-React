...
const StayHome = () => {
  return (
    <div className="max-w-screen-2xl lg:mx-auto m-10 ">
      ...
      <img className="absolute w-full h-full -z-30 transition" src="../../../public/assets/banner/banner-10.png" alt="" />
        ...
        <div className="flex flex-col lg:items-start sm:justify-center gap-4 p-10 lg:p-20">
          ...
          <div
            ...
            <img className="lg:pl-6 pl-3" src="../../../public/assets/others/icon-plane.png" alt="" />
        ...
        <div className="flex justify-center overflow-hidden pt-3">
          <img className="w-10/12 hover:scale-105 transition" src="../../../public/assets/banner/banner-9.png" alt="" />
        </div>
      </div >
    </div>
  )
