      ...
      <div>
        ...
        <div className="grid grid-rows-3 gap-4">
          <div
            ...
            <img className="w-24 rounded-lg" src="../../../public/assets/top selling/thumbnail-1.jpg" alt="" />
            <div>
              <h1>Carrot Nurtition and Health Benifit</h1>
              <div className="flex ">
                <img className="" src="../../../public/assets/popular product/gold-rating-stars.png" alt="" />
                <img className="" src="../../../public/assets/popular product/gold-rating-stars.png" alt="" />
                <img className="" src="../../../public/assets/popular product/gold-rating-stars.png" alt="" />
                <img className="" src="../../../public/assets/popular product/gold-rating-stars.png" alt="" />
                <img className="" src="../../../public/assets/popular product/black-rating-stars.png" alt="" />
              </div>
          ...
          <div
            className="flex items-center gap-4 rounded-lg hover:shadow-lg hover:-translate-x-1 hover:-translate-y-1 transition p-3">
            <img className="w-24 rounded-lg" src="../../../public/assets/top selling/thumbnail-2.jpg" alt="" />
            <div>
          ...
          <div
            className="flex items-center gap-4 rounded-lg hover:shadow-lg hover:-translate-x-1 hover:-translate-y-1 transition p-3">
            <img className="w-24 rounded-lg" src="../../../public/assets/top selling/thumbnail-3.jpg" alt="" />
            <div>
